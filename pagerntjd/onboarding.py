...
st.markdown("""
    <style>
    [data-testid="stSidebar"], [data-testid="stSidebarNav"], [data-testid="stToolbar"] {
...
st.markdown("""
    ...
    .title {
        ...
        font-weight: bold;
        text-align: center;
        margin-top: 40px;     /* 메인페이지 메인박스와 동일한 위치 */
        margin-bottom: 20px;
        color: #222;
    }
    </style>
...
st.markdown("""
<div class="start-btn">
    <a href="/mainpage"><button class="start">시작하기</button></a>
</div>
""", unsafe_allow_html=True)
